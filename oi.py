...
def banner():
	os.system("clear")
	print("")
	print("%s     ____  _   __      ______________  ______"%(M))
	print("%s    / __ \/ | / /     / ____/  _/ __ \/ ____/"%(M))
	print("%s   / / / /  |/ /_____/ /_   / // /_/ / __/"%(M))
	print("%s  / /_/ / /|  /_____/ __/ _/ // _, _/ /___"%(M))
	print("%s  \____/_/ |_/     /_/   /___/_/ |_/_____/"%(M))
	print("")
	print("%s╔══════════════════════════════════════════╗"%(Z))
